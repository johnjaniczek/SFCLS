...
lam = 1e-6                         # weight of p_norm regularization
...
print(metrics.mean())
i = 0
while os.path.exists(result_path + today + "_p_norm_metrics%s.csv" % i):
    i += 1
metrics.to_csv(result_path + today + "_p_norm_metrics%s.csv" % i)
