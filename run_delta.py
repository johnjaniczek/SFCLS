...
lam = 1e-7                      # weight of gravitron regularization
K = 100                               # number of mixtures to test
gauss_dev = 2.5e-300                    # standard deviation of gaussian noise added to mixture
...
print(metrics.mean())
i = 0
while os.path.exists(result_path + today + "_grav_metrics%s.csv" % i):
    i += 1
metrics.to_csv(result_path + today + "_grav_metrics%s.csv" % i)
